...
print(a.b)
```
],[Autogenerated Deinit],[Autogenerated Deinit],
        [SIL Instruction],[`alloc_ref`],[`load_unowned`],[`unowned_release`],[`strong_release`],
        // [`Instructions.md` Description],[],[],[],[],
        [IR Generation Entry],
            link("https://github.com/swiftlang/swift/blob/1885c9bca4c727164da3b93812647b60a258e1f9/lib/IRGen/IRGenSIL.cpp#L6614")[`IRGenSIL.cpp: visitAllocRefInst`],
            link("https://github.com/swiftlang/swift/blob/1885c9bca4c727164da3b93812647b60a258e1f9/lib/IRGen/IRGenSIL.cpp#L6245")[`IRGenSIL.cpp: visitLoad##Name##Inst`],
            [],
            [],
        [IR Generation Intermediates],
            [`emitClassAllocation`, `emitAllocObjectCall`, `emitAllocatingCall`],
...
- benchmark different pointer types
